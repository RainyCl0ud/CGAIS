...
<head>
    ...
    <title>Student Session History Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="stats">
        ...
        <div class="stat-item">
            <div class="stat-number">{{ $stats['cancelled_sessions'] }}</div>
            <div class="stat-label">Cancelled</div>
        </div>
        <div class="stat-item">
            <div class="stat-number">{{ $stats['no_show_sessions'] }}</div>
    ...
    <div class="fixed-footer">
        <p style="font-size:5px; color:#666;">Confidential - For authorized personnel only <span class="page-number"></span></p>
    </div>
</body>
</html>

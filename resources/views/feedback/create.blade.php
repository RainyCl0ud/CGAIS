                    ...
                    <form method="POST" action="{{ route('feedback.store') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select id="counselor_rating" name="counselor_rating" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                        ...
                                        @for($i = 1; $i <= 5; $i++)
                                            <option value="{{ $i }}" {{ old('counselor_rating') == $i ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <select id="service_rating" name="service_rating" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                        <option value="">Select rating</option>
                                        @for($i = 1; $i <= 5; $i++)
                                            <option value="{{ $i }}" {{ old('service_rating') == $i ? 'selected' : '' }}>
                                                {{ str_repeat('★', $i) . str_repeat('☆', 5 - $i) }} ({{ $i }}/5)
                                            </option>
                                        @endfor
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="facility_rating" name="facility_rating" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                        <option value="">Select rating</option>
                                        @for($i = 1; $i <= 5; $i++)
                                            <option value="{{ $i }}" {{ old('facility_rating') == $i ? 'selected' : '' }}>
                                                {{ str_repeat('★', $i) . str_repeat('☆', 5 - $i) }} ({{ $i }}/5)
                                            </option>
                                        @endfor
                                    </select>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <textarea id="counselor_feedback" name="counselor_feedback" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Share your experience with the counselor...">{{ old('counselor_feedback') }}</textarea>
                                    <x-input-error :messages="$errors->get('counselor_feedback')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="service_feedback" value="Service Feedback" />
                                    <textarea id="service_feedback" name="service_feedback" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Share your experience with the counseling service...">{{ old('service_feedback') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea id="suggestions" name="suggestions" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Any suggestions to improve our services...">{{ old('suggestions') }}</textarea>
                                    <x-input-error :messages="$errors->get('suggestions')" class="mt-2" />
                                </div>
                                <div>
                                    <x-input-label for="concerns" value="Concerns or Issues" />
                                    <textarea id="concerns" name="concerns" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Any concerns or issues you'd like to address...">{{ old('concerns') }}</textarea>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="would_recommend" value="1" class="form-radio" {{ old('would_recommend') === '1' ? 'checked' : '' }}>
                                            <span class="ml-2">Yes</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="radio" name="would_recommend" value="0" class="form-radio" {{ old('would_recommend') === '0' ? 'checked' : '' }}>
                                ...
                                <div>
                                    ...
                                    <textarea id="recommendation_reason" name="recommendation_reason" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Please explain your reason...">{{ old('recommendation_reason') }}</textarea>
                        ...
                        <div class="mb-8">
                            ...
                            <div>
                                ...
                                <textarea id="additional_comments" name="additional_comments" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Any additional comments or feedback...">{{ old('additional_comments') }}</textarea>

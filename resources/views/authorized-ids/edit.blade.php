                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('authorized-ids.update', $authorizedId) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('notes', $authorizedId->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>

            ...
            <div class="border-t border-gray-200 pt-4 mt-4">
                ...
                <a href="{{ route('courses.index') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors {{ request()->routeIs('courses.*') ? 'bg-blue-100 text-blue-700' : '' }}">
                    ...
                    <span class="font-medium text-sm">Manage Program</span>
                </a>
                ...
                {{-- <a href="{{ route('document-codes.index') }}"
                   class="flex items-center px-3 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors {{ request()->routeIs('document-codes.*') ? 'bg-blue-100 text-blue-700' : '' }}">
                    <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    <span class="font-medium text-sm">Manage Document Code</span>
                </a> --}}
            </div>

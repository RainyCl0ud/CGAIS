...
class PersonalDataSheetController extends Controller
{
    ...
    public function update(Request $request)
    {
        try {
            ...
            Log::info('PDS Update Request Data: ' . json_encode($request->all()));
            ...
            'guardian_age' => 'nullable|string|max:255',
            ...
            'family_description_other' => 'nullable|string|max:1000',
            'living_situation' => 'nullable|string|max:255',
            'living_situation_other' => 'nullable|string|max:1000',
            ...
            'tutorial_subjects' => 'nullable|string|max:255',

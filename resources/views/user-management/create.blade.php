            ...
            <div class="w-full max-w-4xl mx-auto">
                <div class="bg-white/90 rounded-2xl shadow-2xl border border-blue-100 p-8">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-3xl font-bold text-blue-900">Add New User</h1>
                    ...
                    <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name_extension" name="name_extension" value="{{ old('name_extension') }}"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="role" name="role" required
                                        ...
                                        <option value="staff" {{ old('role') === 'staff' ? 'selected' : '' }}>Non-Teaching Staff</option>
                                    </select>
                                </div>
                        ...
                        <!-- Password -->
                        <div class="space-y-4">
                            <h2 class="text-xl font-semibold text-gray-900 border-b border-gray-200 pb-2">Password</h2>

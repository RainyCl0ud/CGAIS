            ...
            <div class="w-full max-w-6xl mx-auto">
                <div class="bg-white/80 rounded-lg sm:rounded-2xl shadow-lg sm:shadow-2xl border border-blue-100 p-4 sm:p-8 backdrop-blur">
                    <div class="mb-4 sm:mb-6">
                        ...
                        <div class="text-gray-600 text-xs sm:text-sm">{{ now()->format('l, F d, Y') }} | Access your counseling services</div>
                    </div>
                        ...
                        <div class="bg-blue-50 p-3 sm:p-6 rounded-lg border border-blue-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3 sm:ml-4">
                                    <p class="text-xs sm:text-sm font-medium text-gray-600">My Appointments</p>
                        ...
                        <div class="bg-purple-50 p-3 sm:p-6 rounded-lg border border-purple-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3 sm:ml-4">
                                    ...
                                    <p class="text-lg sm:text-2xl font-semibold text-gray-900">{{ $stats['upcoming_appointments'] ?? 0 }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Faculty's Upcoming Appointments -->
